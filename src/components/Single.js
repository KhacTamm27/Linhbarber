          ...
          <div class="single-w3pvt-page mt-md-5 mt-4 px-lg-5">
            <div class="content-sing-w3ls px-lg-5">
              ...
              <p>
                ...
                những dịch vụ chăm sóc tóc chất lượng cao nhất. Với đội ngũ thợ
                cắt tóc chuyên nghiệp và trang thiết bị hiện đại, chúng tôi tự
                tin mang đến cho bạn những trải nghiệm tuyệt vời nhất.
              </p>
              <p class="mt-3">
                ...
                nhất. Từ kiểu tóc cổ điển đến hiện đại, chúng tôi có thể tạo ra
                bất kỳ kiểu nào mà khách hàng mong muốn.
              </p>
            ...
            <div class="row my-lg-5 mt-3 mx-0">
              <div class="col-lg-6 text-info pl-0">
                <p>
                  ...
                  nghiệp với đội ngũ thợ cắt tóc có kinh nghiệm lâu năm. Từ cắt
                  tóc, cạo râu đến nhuộm tóc, chúng tôi đảm bảo mang đến cho
                  khách hàng những trải nghiệm tốt nhất. Với không gian thoải
                  mái và trang thiết bị hiện đại, chúng tôi tự tin là lựa chọn
                  hàng đầu cho nam giới.
                </p>
              </div>
                ...
                <li class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p class="mt-3">
                      ...
                      chuyên nghiệp và tận tâm. Tôi rất hài lòng với kết quả và
                      sẽ quay lại lần nữa.
                    </p>
                  </div>
                </li>
                <li class="media my-5 ml-3">
                  ...
                  <div class="media-body">
                    ...
                    <p class="mt-3">
                      ...
                      phục vụ rất nhiệt tình và chuyên nghiệp. Tôi rất hài lòng
                      với dịch vụ.
                    </p>
                  </div>
                </li>
                <li class="media ml-5">
                  ...
                  <div class="media-body">
                    ...
                    <p class="mt-3">
                      ...
                      lại lần nữa và giới thiệu cho bạn bè. Chất lượng dịch vụ
                      rất tốt.
                    </p>
                  </div>
                </li>
