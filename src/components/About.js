            ...
            <div class="row mid-grids mt-lg-5 mt-3">
              ...
              <div class="col-md-7 content-left-bottom entry-w3ls-info text-left mt-3">
                ...
                <p class="mt-2 text-left">
                  ...
                  năm, chúng tôi cam kết mang đến cho khách hàng những dịch vụ
                  tốt nhất. Chúng tôi sử dụng các sản phẩm chất lượng cao và kỹ
                  thuật cắt tóc tiên tiến để đảm bảo khách hàng có được kiểu tóc
                  hoàn hảo nhất.
                </p>
              </div>
            </div>
            <div class="row mid-grids mt-lg-5 mt-3 py-3">
              <div class="col-md-7 content-left-bottom entry-w3ls-info text-left mt-3">
                ...
                <p class="mt-2 text-left">
                  ...
                  Từ kiểu râu cổ điển đến hiện đại, chúng tôi có thể tạo ra bất
                  kỳ kiểu nào mà khách hàng mong muốn. Với kỹ thuật cắt tỉa
                  chuyên nghiệp và sản phẩm chăm sóc râu chất lượng cao, chúng
                  tôi đảm bảo khách hàng có được bộ râu hoàn hảo và phù hợp với
                  khuôn mặt.
                </p>
              </div>
            ...
            <div class="row mt-lg-5 mt-4">
              ...
              <div class="col-md-4 team-gd second text-center my-md-0 my-5">
                ...
                <div class="team-info">
                  ...
                  <p>
                    Chuyên gia về các kiểu râu và ria mép, Deen có thể tạo ra
                    bất kỳ kiểu râu nào mà khách hàng mong muốn.
                  </p>
                  <ul class="list-unstyled team-icons mt-4">
                    <li>
                      <a href="#" class="t-icon">
